...
int main() {
    ...
    // Telex "e" again: e -> ê, the only character to delete plus the trigger backspace.
    ...
    // The page reports the composer emptied; the settle wait must still hold the commit.
